...
//                                            lane_id,     // thread id
//                                            threads_per_group, // stride in
//                                            group scalar_op_cache);  // scalar
//                                            handler
...
//     float q = fminf(fmaxf(static_cast<float>(src) / y_s, min_8bit),
//     max_8bit); dst = DST_DTYPE(q);
//   };
...
//                                torch::Tensor &output_q, torch::Tensor
//                                &output_s, int64_t group_size, double eps,
//                                double fp8_min, double fp8_max, bool
//                                scale_ue8m0) {
